...
setlocal
pushd "%~dp0" || exit /b 1
set "candidate=dist\chat-follow-update\ataraxia-950-1.0-UNTRACKED.jar"
set "expected=473527e4491d55ebac30bf8bbd6707dbb50d078cf47f389efbdbd3f57759c3dd"
...
if /i "%~1"=="--check-only" (
 echo Chat and Follow candidate hash verified. Nothing installed or restarted.
 popd
 exit /b 0
)
...
if not errorlevel 1 goto running
set "backup=backups\manual-chat-follow-%RANDOM%-%RANDOM%"
...
echo Chat and Follow update installed. Backup: %backup%
