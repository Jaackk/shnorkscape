...
public final class FfaZone extends Controller {
    ...
    public void sendInterfaces() {
        ...
        player.getInterfaceManager().sendOverlay(789, player.getInterfaceManager().hasRezizableScreen());
    }
                    ...
                    if (risk) {
                        ...
                        if (killer != null) {
                            ...
                            if (player.isGroupIronman()) {
                                player.gimTracker.incrementDeaths("<#player> died while in Clan wars (FFA)");
                            }
                        }
                    }
