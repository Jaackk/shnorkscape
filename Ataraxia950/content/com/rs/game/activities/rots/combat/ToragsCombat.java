...
/**
 * @author Kris | 3. sept 2017 : 23:39.43
 * @see <a href="https://www.rune-server.ee/members/kris/">Rune-Server profile</a>}
 */
public class ToragsCombat extends CombatScript {
	...
	public int attack(NPC npc, Entity target) {
		final ToragNPC n = (ToragNPC) npc;
		if (n.getEffect() != null && !(n.getEffect() instanceof ShadowDrag)) 
			return 1;
		final RiseOfTheSix instance = ((RiseOfTheSixNPC) npc).getInstance();
		int damage = getRandomMaxHit(npc, instance.withinShadowRealm() ? 492 : 246, NPCCombatDefinitionConstants.MELEE, target);
