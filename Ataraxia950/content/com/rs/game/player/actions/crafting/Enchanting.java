...
public class Enchanting {
	...
	public static boolean enchant(Player player, int reqLevel, int toEnchant, int toMake, int enchantLevel) {
		...
		} else if (enchantLevel == 6 || enchantLevel == 7) {
			player.setNextAnimation(new Animation(721));
		...
		player.sendFilteredMessage("You enchant the " + name + " and make a " + makeName + "!");
		player.getInterfaceManager().openGameTab(7);
		return true;
	}
	...
	public enum Types {
		...
		DRAGONSTONE(5, 68, 20659, 11105, 1712, 11118),
		ONYX(6, 87, 6583, 11128, 6585, 11133),
		HYDRIX(7, 87, 31869, 31872, 31875, 31878);
	...
	public enum Base {
		...
		DRAGONSTONE(5, 1645, 1664, 1702, 11115),
		ONYX(6, 6575, 6577, 6581, 11130),
		HYDRIX(7, 31857, 31859, 31863, 31865);
