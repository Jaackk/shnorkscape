package com.rs.game.player.actions.summoning.defs;
...
public enum SummoningScroll {
	...
	TITANS_CONSTITUTION_SCROLL_2(12824, 79, 7.9, new Item(12804)),
	TITANS_CONSTITUTION_SCROLL_3(12824, 79, 7.9, new Item(12806)),
	...
	SummoningScroll(int itemId, int levelRequired, double experience, Item pouch) {
		this.itemId = itemId;
