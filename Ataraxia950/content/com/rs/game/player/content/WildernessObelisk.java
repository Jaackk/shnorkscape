...
public class WildernessObelisk {
	...
	public static final WorldTile[] OBELISK_CENTER_TILES = { new WorldTile(2978, 3864, 0), new WorldTile(3033, 3730, 0),
			new WorldTile(3104, 3792, 0), new WorldTile(3154, 3618, 0), new WorldTile(3217, 3654, 0),
			new WorldTile(3305, 3914, 0) };
			...
			public void run() {
				...
				if (playerIndexes != null) {
					for (Integer i : playerIndexes) {
						...
						p.getTemporaryAttributtes().put("obelisktele", Boolean.TRUE);
						...
						p.getPackets().sendGameMessage("Ancient magic teleports you to a place within the wilderness!",
								true);
					}
				}
