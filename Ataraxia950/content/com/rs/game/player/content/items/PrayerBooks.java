...
public class PrayerBooks {
	...
	private static final int[] ANIMATIONS = { 1335, 1336, 1337, -1, -1, -1 };
	...
	public static void bindPages(Player player, int bookId) {
		...
		player.sendMessage("You will need all 4 pages in order to complete your Prayer book.");
	}
	...
	public static void sermanize(Player player, final int bookId) {
		...
		player.getDialogueManager().startDialogue(new Dialogue() {
			...
			@Override
			public void start() {
				sendOptionsDialogue("Select a relevant passage.", "Wedding Cerimoney", "Last Rites", "Blessings",
						"Preach");
			}
