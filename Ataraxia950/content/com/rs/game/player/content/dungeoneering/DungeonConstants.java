...
import com.rs.game.player.content.dungeoneering.rooms.puzzles.MonolithRoom;
...
public class DungeonConstants {
	...
	public enum SkillDoors {
		...
		DIVINE_DOOR(Skills.DIVINATION, new int[] 
		{ 17152, 17153, 17155, 17158, 17159}, new int[]
		{ 17160, 17161, 17162, 17163, 55762 }, 21226, -1, -1, -1, -1, -1, "The energy in the wisp is too strong for you."),
        ...
        private final int openGfx;
        private final int openObjectAnim;
        private final int failObjectAnim;
        private final int failAnim;
        private final int failGfx;
		private final int[] closedThemeObjects;
        private final int[] openThemeObjects;
	...
	public static final int[] DIVINATION_CREATURES = {
			18150, 18151, 18153, 18155, 18157, 18159, 18161, 18163, 18165, 18167
	};
	...
	public enum Puzzle {
		...
		MONOLITH(8, MonolithRoom.class, list(spot(4, 4), spot(4, 4), spot(4, 4), spot(4, 4), spot(4, 4), spot(4, 4), spot(4, 5))),
		CRYSTAL_PUZZLE(12, CrystalPuzzleRoom.class, all(spot(13, 5))),
		//GHOSTS_PUZZLE(14, GhostsRoom.class, list(spot(1, 2), spot(3, 10), spot(1, 3), spot(1, 3), spot(1, 3), spot(1,3), spot(3,3))),
		//THREE_STATUE_WEAPON(16, ThreeStatueWeaponRoom.class, list(spot(8, 7), spot(4, 11), spot(12, 3), spot(7, 3), spot(2, 3), spot(1, 10), spot(5, 14))),
		//FOLLOW_THE_LEADER(18, FollowTheLeader.class, all(spot(7, 6))),
		...
		public VisibleRoom newInstance() {
			try {
				...
				Logger.getGlobal().error("error creating puzzle instance", e);
				return null;
			}
		}
		...
		private static int[][] list(int[]... list) {
			if (list.length != 7) {
				Logger.getGlobal().warn("Error in key list " + Arrays.toString(list));
				return null;
			}
			return list;
		}
...
//}
	...
	public static final int NORMAL_NPC = 0, GUARDIAN_NPC = 1, FISH_SPOT_NPC = 2, BOSS_NPC = 3, FORGOTTEN_WARRIOR = 4, SLAYER_NPC = 5, HUNTER_NPC = 6, PUZZLE_NPC = 7, DIVINATION_NPC = 8;
