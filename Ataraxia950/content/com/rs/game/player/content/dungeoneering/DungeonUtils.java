...
public final class DungeonUtils {
	...
	public static int getDivinationCreature() {
		return DungeonConstants.DIVINATION_CREATURES[Utils.random(DungeonConstants.DIVINATION_CREATURES.length)];
	}
	...
	public static boolean theresDoorTo(RoomReference checkRoom, Room[][] map) {
        ...
        return checkRoom.getY() != map[checkRoom.getX()].length - 1 && map[checkRoom.getX()][checkRoom.getY() + 1] != null && map[checkRoom.getX()][checkRoom.getY() + 1].hasSouthDoor();
