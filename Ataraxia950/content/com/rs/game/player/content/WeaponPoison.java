...
/**
 * Handles weapon/ammunition poisonong.
 *
 * @author Noel
 */
public class WeaponPoison {
	...
	/**
	 * Holds Poison potion ID's.
	 */
	public static int[][] POISON = new int[][] { 
		{ 187, 5937, 5940 }, 
		{ 17572, 17596, 17620 } };

	/**
	 * Gets the Item ID to poison.
	 *
	 * @param id
	 *            The ID to get.
	 ...
	 * @return if can Poison.
	 */
	public static boolean poisons(Player player, Item item1, Item item2, boolean dungeoneering) {
	...
	/**
	 * An encum containing all poisonable item ID's.
	 *
	 * @author Noel
	 */
	public enum Weapon {
