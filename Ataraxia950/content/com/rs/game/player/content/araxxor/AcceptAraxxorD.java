 ...
 *        1.1 (beta, 08/19/2017)
 */
public class AcceptAraxxorD extends Dialogue {
	...
	public void start() {
		...
		stage = 0;
		sendDialogue(leader.getDisplayName() + " has invited you to join  " + (leader.getAppearence().isMale() ? "his " : "her ") + " battle at the Araxyte hive.", Colors.RED + "There is no way " + "out other than death or Victory.");
	}
	...
	public void run(int interfaceId, int componentId) {
		if (stage == 0) {
			stage = 1;
			sendOptionsDialogue("Join " + leader.getDisplayName() + " in the Araxyte hive?", "Yes, I'm ready.", "No, I don't wish to join.");
		} else if (stage == 1) {
			switch (componentId) {
			case OPTION_1:
				...
				break;
			case OPTION_2:
				leader.sendMessage(Colors.RED + player.getDisplayName() + " has declined your offer.");
				end();
				break;
			}
		}
