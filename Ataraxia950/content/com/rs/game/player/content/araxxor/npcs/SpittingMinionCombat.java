...
public class SpittingMinionCombat extends CombatScript {
	...
	private void rangeAutoAttack(SpittingMinion minion, Entity target, NPCCombatDefinition defs) {
	...
	public Object[] getKeys() {
		return new Object[] { /* AraxyteMinion.MinionType.SPITTING.npcId */ "old spiting spider" };
	}
}
