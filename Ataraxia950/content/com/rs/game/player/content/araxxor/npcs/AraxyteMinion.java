...
/**
 * Abstract base class for Araxyte minion NPCs. All minion subtypes inherit the {@link AraxyteMinion#performRole()} method, with type-specific
 * implementations. Araxxor and Araxxi are capable of spawning 5 different types of minions. See the subclasses for their roles. <br/>
 * <br/>
...
abstract class AraxyteMinion extends NPC {
	...
	enum MinionType {
		...
		BLADED(19458), SPITTING(19460), IMBUED(19459), PULSING(19469), MIRRORBACK(19468);
