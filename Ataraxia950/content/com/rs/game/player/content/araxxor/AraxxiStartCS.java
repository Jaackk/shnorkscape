...
public class AraxxiStartCS extends Cutscene {
	...
	public CutsceneAction[] getActions(Player player) {
		...
		actions.add(new PosCameraAction(getX(player, anchor.getX()), getY(player, anchor.getY()), 2800, -1));
		actions.add(new LookCameraAction(getX(player, look.getX()), getY(player, look.getY()), 2000, 2));
