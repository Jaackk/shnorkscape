...
public class LightPathCutscene extends Cutscene {
	...
	public CutsceneAction[] getActions(Player player) {
		...
		actions.add(new PosCameraAction(getX(player, firstAnchorPos.getX()), getY(player, firstAnchorPos.getY()), 2800, -1));
		actions.add(new LookCameraAction(getX(player, firstLookPos.getX()), getY(player, firstLookPos.getY()), 2000, 5));
		actions.add(new PosCameraAction(getX(player, secondAnchorPos.getX()), getY(player, secondAnchorPos.getY()), 3500, -1));
		actions.add(new LookCameraAction(getX(player, secondLookPos.getX()), getY(player, secondLookPos.getY()), 3500, 5));
