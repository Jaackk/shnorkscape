...
public class Rammernaut extends DungeonBoss {
	...
	public void fail() {
		setNextAnimationForce(new Animation(13707));
	...
	public void sucess() {
		resetWalkSteps();
		setNextAnimationForce(new Animation(13698));
			...
			WorldTasksManager.schedule(new WorldTask() {
				...
				public void run() {
					...
					if (ticks == 1) {
						...
						entity.setNextAnimationForce(new Animation(10070));
	...
	public void processNPC() {
		...
		//    Logger.getGlobal().info("Time to charge " + chargeCount);
		    return 0;
		}*/
	}
