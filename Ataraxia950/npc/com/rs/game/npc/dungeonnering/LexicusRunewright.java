...
public class LexicusRunewright extends DungeonBoss {
	...
	private final List<TombOfLexicus> books = new CopyOnWriteArrayList<TombOfLexicus>();
	...
	public void sendTeleport() {
		...
		setNextAnimationForce(new Animation(13499));
		...
		WorldTasksManager.schedule(new WorldTask() {
			...
			public void run() {
				...
				if (cycles == 2) {
					...
					setNextAnimationForce(new Animation(13500));
