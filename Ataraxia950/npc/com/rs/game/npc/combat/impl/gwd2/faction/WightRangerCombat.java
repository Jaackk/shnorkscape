...
public class WightRangerCombat extends CombatScript {

	@Override
	public int attack(NPC npc, Entity target) {
		npc.setNextAnimation(new Animation(18237));
		npc.setNextGraphics(new Graphics(1116, 0, 90));
		World.sendProjectile(new NewProjectile(npc, target, 805, 35, 30, 40, 5, 100, 0));
