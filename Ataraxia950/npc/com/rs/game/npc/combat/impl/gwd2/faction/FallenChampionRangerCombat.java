...
public class FallenChampionRangerCombat extends CombatScript {

	@Override
	public int attack(NPC npc, Entity target) {
		npc.setNextAnimation(new Animation(18237));
		npc.setNextGraphics(new Graphics(1116, 0, 120));
		World.sendProjectile(new NewProjectile(npc, target, 1120, 50, 30, 45, 5, 100, 0));
