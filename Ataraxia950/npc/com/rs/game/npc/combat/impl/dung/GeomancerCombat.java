...
public class GeomancerCombat extends CombatScript {
	...
	private void sendEarthBlast(NPC npc, Entity target, boolean multiAttack) {
		...
		for (Entity t : npc.getPossibleTargets()) {
			...
			delayHit(npc, 1, t, getMagicHit(npc, getRandomMaxHit(npc, (int) (npc.getMaxHit(NPCCombatDefinitionConstants.MAGE) * .7), NPCCombatDefinitionConstants.MAGE, t)));
		}
	}
	...
	private void sendEntangle(NPC npc, Entity target) {
		...
		int damage = getRandomMaxHit(npc, (int) (npc.getMaxHit(NPCCombatDefinitionConstants.MAGE) * 0.95), NPCCombatDefinitionConstants.MAGE, target);
	...
	private void sendPrayerSpell(NPC npc) {
		...
		for (Entity t : npc.getPossibleTargets()) {
			int damage = getMaxHit(npc, NPCCombatDefinitionConstants.MAGE, t);
