...
public class AutomatonMageCombat extends CombatScript {

	@Override
	public int attack(NPC npc, Entity target) {
		npc.setNextGraphics(new Graphics(3564, 0, 60));
		npc.setNextAnimation(new Animation(18364));
		World.sendProjectile(new NewProjectile(npc, target, 3565, 40, 25, 70, 5, 75, 0));
