...
public class BulbouscrawlerCombat extends CombatScript {
	...
	public void mageAttack(NPC npc, Entity target) {
		for (Entity t : npc.getPossibleTargets()) {
			npc.setNextAnimation(new Animation(31110));
