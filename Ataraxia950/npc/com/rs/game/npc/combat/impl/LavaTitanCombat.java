...
public class LavaTitanCombat extends CombatScript {
	...
	public int attack(NPC npc, Entity target) {
		...
		if (usingSpecial) {// priority over regular attack
			...
			delayHit(npc, 1, target, getMeleeHit(npc, getRandomMaxHit(npc, 140, NPCCombatDefinitionConstants.MELEE, target)));
			...
			damage = getRandomMaxHit(npc, 140, NPCCombatDefinitionConstants.MELEE, target);
