...
public class HydrixDragonCombat extends CombatScript {

    private static final int DOUBLE_TRAIL_PROJ = 6573, MAGIC_PROJ = 2730;
    private static final int MELEE_MAX = 175, MAGIC_MAX = 175, DRAGONFIRE_MAX = 600, SPECIAL_MAX = 390;
    ...
    private static final Graphics DRAGONFIRE_GFX = new Graphics(5549), IMPACT_GFX = new Graphics(6577);
                ...
                public void run() {
                    ...
                    if (target.withinDistance(impactTile, 1)) {
                        ...
                        if (target instanceof Player) {
                            ...
                            p.getCombatDefinitions().setSpecialAttack(0);
                            p.getPackets().sendPlayerMessage(1, 15263739, "The attack drains your special attack!", true);
                        }
                    }
                }
    ...
    public Object[] getKeys() {
        return new Object[] { "Hydrix dragon" };
    }
