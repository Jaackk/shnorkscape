...
public class Nomad extends NPC {
	...
	public void sendDeath(Entity source) {
		if (throneTile != null) {
			target.lock();
			target.getPackets().sendConfigByFile(30519, 0, true);
			...
			WorldTasksManager.schedule(new WorldTask() {
				...
				public void run() {
					...
					QueryExecutor.submit(new News(target, "<b><img src=\"../bin/images/news/nomad.png\" height=17> "
							+ target.getDisplayName() + " has just completed the Nomad mini-quest."));
