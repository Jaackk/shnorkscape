 ...
 */
public class ThievingRandomEvent extends RandomEventNPC {

	private static final long serialVersionUID = -7923903315203528862L;
	 ...
	 * @param target
	 */
	public ThievingRandomEvent(WorldTile tile, Player target) {
		super(8122, tile, target);
	}
	...
	public void giveReward(Player player) {
		...
		player.sendMessage("<col=ff0000>The Rogue gives you a reward before leaving.");
