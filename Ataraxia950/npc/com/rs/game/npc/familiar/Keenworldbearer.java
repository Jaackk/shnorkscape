...
public class Keenworldbearer extends Familiar {

	private static final long serialVersionUID = -422253696115269167L;

	public Keenworldbearer(Player owner, Pouches pouch, WorldTile tile, int mapAreaNameHash,
	...
	public String getSpecialDescription() {
		return "Each use of the scroll restores up to 26% of the player's run energy.";
	}
	...
	public boolean submitSpecial(Object object) {
		...
		int runEnergy = (int) (player.getRunEnergy() * 1.26);
