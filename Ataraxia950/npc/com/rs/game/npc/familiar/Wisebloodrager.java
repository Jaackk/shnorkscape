...
public class Wisebloodrager extends Familiar {

	private static final long serialVersionUID = 4970310429889437114L;

	public Wisebloodrager(Player owner, Pouches pouch, WorldTile tile, int mapAreaNameHash,
	...
	public String getSpecialDescription() {
		return "Deals a more damaging attack that is 40% more accurate, and reduces opponent's Defence.";
	}
