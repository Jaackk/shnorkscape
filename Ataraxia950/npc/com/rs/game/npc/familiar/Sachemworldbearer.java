...
public class Sachemworldbearer extends Familiar {

	private static final long serialVersionUID = -422253696115269167L;

	public Sachemworldbearer(Player owner, Pouches pouch, WorldTile tile, int mapAreaNameHash,
	...
	public String getSpecialDescription() {
		return "Each use of the scroll restores up to 40% of the player's run energy.";
	}
	...
	public boolean submitSpecial(Object object) {
		...
		int runEnergy = (int) (player.getRunEnergy() * 1.4);
