...
public class Clayfamiliarclass5 extends Familiar {
	...
	public Clayfamiliarclass5(Player owner, Pouches pouch, WorldTile tile, int mapAreaNameHash,
	...
	public boolean submitSpecial(Object object) {
		...
		// !(getOwner().getControlerManager().getControler() instanceof
		// StealingCreationController)) {
		// dissmissFamiliar(false);
		// return false;
		// }
		getOwner().setNextGraphics(new Graphics(1316));
		getOwner().setNextAnimation(new Animation(7660));
		// StealingCreationController sc = (StealingCreationController)
		// getOwner().getControlerManager().getControler();
