...
public final class FireWallAttack implements QueenAttack {
	...
	public int attack(final QueenBlackDragon npc, final Player victim) {
										...
										if (!((wallId == 3158 && victim.getX() == npc.getBase().getX() + 28)
											...
											if (victim.getY() == npc.getBase().getY() + y) {
												...
												if (message != null) {
													...
													victim.sendMessage(
															"You are horribly burned by the dragons fiery wall!", true);
												}
		...
		npc.getTemporaryAttributtes().put("fire_wall_tick_", npc.getTicks() + Utils.random((waves * 7) + 5, 60)); // Don't
		// make
		// it
		// too
		// often.
