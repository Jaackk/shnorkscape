package com.rs.cache.filestore.io;
...
public final class InputStream extends Stream {
	...
	public int read24BitIntV1() {
		return (readUnsignedByte() << 16) + (readUnsignedByte()) + (readUnsignedByte() << 8);
	}

	public int read24BitIntV2() {
		return (readUnsignedByte() << 8) + (readUnsignedByte() << 16) + (readUnsignedByte());
	}

	public int read24BitIntV3() {
		return (readUnsignedByte() << 8) + (readUnsignedByte()) + (readUnsignedByte() << 16);
	}

	public int read24BitIntV4() {
		return (readUnsignedByte()) + (readUnsignedByte() << 8) + (readUnsignedByte() << 16);
	}

	public int read24BitIntV5() {
		return (readUnsignedByte()) + (readUnsignedByte() << 16) + (readUnsignedByte() << 8);
	}
	...
	public int readIntV3() {
		return (readUnsignedByte() << 24) + (readUnsignedByte()) + (readUnsignedByte() << 16)
				+ (readUnsignedByte() << 8);
	}
