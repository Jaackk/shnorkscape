...
public final class ReferenceTable {
    ...
    private void decodeHeader() {
        ...
        // CHANGED: Allow Protocol 8 to pass the check
        ...
        named = (0x01 & this.archive.getHash()) != 0;
        usesWhirpool = (0x02 & this.archive.getHash()) != 0;
        boolean flag4 = (this.archive.getHash() & 0x04) != 0;
        boolean flag8 = (this.archive.getHash() & 0x08) != 0;

        // Since this says protocol >= 7, it will automatically handle protocol 8 perfectly!
