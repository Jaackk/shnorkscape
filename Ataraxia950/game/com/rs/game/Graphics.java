...
public final class Graphics implements Serializable {
    ...
    public Graphics(int id, int speed, int height, int rotation) {
        this(id, speed, height, rotation, false);
    }

    public Graphics(int id, int speed, int height, int rotation, boolean forceRefresh) {
        this.id = id;
        this.speed = speed;
        this.height = height;
    ...
    public Graphics(int id, int speed, int height, int rotation, boolean forceRefresh, int customValue) {
        this.id = id;
        this.speed = speed;
        this.height = height;
        this.rotation = rotation;
