...
/**
 * @author Kris | 9. sept 2018 : 22:54:23
 * @see <a href="https://www.rune-server.ee/members/kris/">Rune-Server profile</a>
 * @see <a href="https://rune-status.net/members/kris.354/">Rune-Status profile</a>
 */
public class InstancedKalgerionDemon extends Kalgerion implements InstancedNPC {

	private static final long serialVersionUID = 2595921640890481973L;
    private final PZInstance area;

	public InstancedKalgerionDemon(final int id, final WorldTile tile, PZInstance area) {
		super(id, tile);
