...
public class SurokMagisT extends Dialogue {
	...
	public void run(int interfaceId, int componentId) {
		...
		case -1:
			stage = -2;
			sendPlayerDialogue(NORMAL, "What the? This power again! It must be Zamorak! "
					+ "I can't fight something this strong! " + "I better loot what I can and get out of here!");
			break;
		default:
			end();
			break;
