	...
	public void start() {
		...
		if (player.getLastBork() == 0) {
			...
			sendNPCDialogue(npcId, ANGRY,
					"Our Lord Zamorak has power over life and death, " + "" + player.getDisplayName()
							+ "! He has seen fit to resurrect Bork to continue "
							+ "his great work...and now you will fall before him!");
	}
