 ...
 * @author Noel
 */
public class BossDTeleports extends Dialogue {

    // NOTE: AFAIK this isn't being used anywhere. Should probably be deleted
    ...
    public void run(int interfaceId, int componentId) {
        switch (stage) {
            ...
            case 4:
                ...
                if (componentId == OPTION_5) {
                    sendOptionsDialogue("Choose your destination", "Vorago", "The Heart", Colors.RED + "More Options..");
                    stage = 5;
                }
                break;
            case 5:
                switch (componentId) {
                    case OPTION_1:
                        ...
                        break;
                    case OPTION_2:
                        teleportPlayer(player, 3382, 2878, 0, null);
                        break;
                    case OPTION_3:
                        sendOptionsDialogue("Choose your destination", "Godwars Dungeon", "Corporeal Beast", "Kalphite Queen",
                                "Queen Black Dragon", Colors.RED + "More Options..");
     ...
     * @param placePlane The Z coordinate.
     */
