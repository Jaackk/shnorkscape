...
public class TrainingTeleports extends Dialogue {
	...
	public void start() {
		...
		sendOptionsDialogue("Choose your destination", "Rock Crabs", "Yaks", "Glacor Cave", "Dwarf Battlefield",
	...
	public void run(int interfaceId, int componentId) {
		...
		case -1:
			...
			case OPTION_1:
				...
				break;
			case OPTION_2:
				Magic.vineTeleport(player, new WorldTile(2326, 3803, 0));
				break;
			case OPTION_3:
			...
			case OPTION_4:
				...
				break;
			case OPTION_5:
				sendOptionsDialogue("Select an option", "Frost Dragons", "Rune Dragons", "Slayer Locations", Colors.RED + "More Options..");
				stage = 1;
				break;
			}
			break;
		...
		case 1:
			...
			case OPTION_1:
				...
				break;
			case OPTION_2:
				Magic.vineTeleport(player, new WorldTile(2367, 3357, 0));
				break;
			case OPTION_3:
