...
public final class MiningGuildDwarf extends Dialogue {
	...
	public void run(int interfaceId, int componentId) {
		...
		case 1:
			...
			sendEntityDialogue(SEND_4_TEXT_CHAT, new String[] { NPCDefinitions.getNPCDefinitions(npcId).name,
					"Ooh, it's WONDERFUL! There are lots of coal rocks,", "and even a few mithril rocks in the guild,",
		...
		case 3:
			...
			sendEntityDialogue(SEND_2_TEXT_CHAT, new String[] { NPCDefinitions.getNPCDefinitions(npcId).name,
					"Sorry, but rules are rules. Do some more training first.", "Can I help you with anything else?" },
					IS_NPC, npcId, 9827);
			break;
		case 4:
			stage = 5;
