...
public class FuriesChosen extends Dialogue {

	private static final int NPC = 22434;
	private int option;
	...
	public void start() {
		...
		if (option == 2) {
			...
			sendNPCDialogue(NPC, NORMAL, "Welcome, mortal.");
	}
	...
	public void run(int interfaceId, int componentId) {
		...
		case 1:
			sendNPCDialogue(NPC, NORMAL, "You find yourself in the Heart of Gielinor, adventurer. "
					+ "Hear the cries and relish the chaos of the battlefield as the forces "
					+ "of Zamorak do battle with the vile minions of Zaros, Sliske and Seren!");
			break;
		case 2:
			sendNPCDialogue(NPC, NORMAL, "Leading us into battle are the ferocious Twin Furies: Avaryss the "
					+ "unceasing and Nymora the vengeful.");
			break;
		case 3:
		...
		case 5:
			sendNPCDialogue(NPC, NORMAL, "so we must do what we can to persuade the mercenaries "
					...
					+ "I assure you, I'll make it worth your while to fight for Zamorak.");
			stage = -1;
			return;
		case 10:
			HeartOfGielinor.sendReputationInterface(player, HeartOfGielinor.ZAMORAK);
			end();
			return;
		case 20:
