	...
	public void run(int interfaceId, int componentId) {
		if (stage == -1) {
			...
			sendDialogue(
					...
					"It is intriguing that you took so before comming to me. Fearful,", "traveller?");
			...
			sendDialogue("Intriguing. "
					+ (stage == 100 ? "Such belief in your own abilities..." : "I sence humility in you."));
			if (stage == 101)
			...
			sendDialogue(
					...
					"confidence, you can figure it out yourself. I am the tower, I am",
