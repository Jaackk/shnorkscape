...
public class CombinationsD extends Dialogue {
	...
	public void run(int interfaceId, int componentId) {
		...
		if (componentIndex >= combination.getProducedNodes().length || componentIndex < 0) {
			return;
		}
	...
	public enum Combinations {
	    ...
	    MUD_PART1(1, 0, new Item(2315), new Item(7164), COMBINE, new Item(6032)),
	    MUD_PART2(1, 0, new Item(7164), new Item(7166), COMBINE, new Item(1929)),
	    MUD_PART3(1, 0, new Item(7166), new Item(7168), COMBINE, new Item(434)),
		/**
		 * Breads
		 */
		...
		private final Item initialNode;
		private final Item[] producedNodes;
		private final double[] experience;
		private final int requiredLevel;
		private final Object[] parameters; // type, requirments for certain type
