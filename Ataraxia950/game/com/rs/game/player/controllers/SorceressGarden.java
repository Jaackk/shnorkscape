...
public class SorceressGarden extends Controller {
	...
	public boolean processObjectClick1(WorldObject object) {
		...
		} else if (object.getDefinitions().name.equalsIgnoreCase("herbs")) {
	...
	public enum Gate {
		...
		private static final Map<Integer, Gate> Gates = new HashMap<Integer, Gate>();
		...
		private final WorldTile outside;
