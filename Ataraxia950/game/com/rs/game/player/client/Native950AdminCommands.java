...
public final class Native950AdminCommands {
    ...
    private static final CommandGroup[] COMMAND_DIRECTORY = {
            ...
            group("NPCS & TRAVEL", "fda4af", "fecdd3",
                    ...
                    entry(";;clearobjects / ;;clearobjs [0-128]", "remove your placed objects within radius (default 16), including saved placements; map objects and other owners are protected"),
            ...
            group("DEVELOPMENT", "f9a8d4", "fbcfe8",
                    entry(";;gameval [name or ID]", "browse verified cache symbols and their revision provenance"),
