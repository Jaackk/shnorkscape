...
public final class ClanRank implements Serializable {
	...
	public static void showRanks(Player player, int option) {
		...
		player.getPackets().sendIComponentText(1142, 5, rankText);
		player.getPackets().sendIComponentText(1142, 2, title);
		player.getInterfaceManager().sendInterface(1142);
	}
