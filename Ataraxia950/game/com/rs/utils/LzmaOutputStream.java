...
public class LzmaOutputStream extends CoderOutputStream {
    public LzmaOutputStream(final OutputStream out, final LzmaEncoderWrapper wrapper) throws IOException {
        super(out, wrapper);
    }

    public LzmaOutputStream(final OutputStream out, final Encoder lzmaEncoder, long length) throws IOException {
        this(out, new LzmaEncoderWrapper(lzmaEncoder, length));
    }
    ...
    public static class Builder {
        ...
        public LzmaOutputStream build() throws IOException {
            ...
            return new LzmaOutputStream(out, encoder, -1);
        }
    }
}
