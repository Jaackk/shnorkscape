...
public class MapUtils {
	...
	public enum Structure {
		...
		private final StructureEncoder encoder;
		...
		Structure(Structure child, int width, int height, StructureEncoder encode, StructureDecoder decoder) {
			this.child = child;
			this.width = width;
			this.height = height;
			this.encoder = encode;
		...
		Structure(Structure child, int width, int height) {
	...
	private interface StructureEncoder {
		...
		int encode(int x, int y, int plane);
