"""Package the already-built V3 candidate. Never install or restart.
...
NAME='developer-console-v3-20260925'
...
def main():
    ...
    m.update(candidate=NAME,sourceCommit=subprocess.check_output(['git','rev-parse','HEAD'],cwd=ROOT).decode().strip(),
             validationReport='protocol-analysis/developer-console-v3-950.json',
             liveChecklist='docs/DEVELOPER-CONSOLE-V3-20260925.md',
             liveAcceptance='V3 polish checkpoint. Automated verification is recorded in the report; new Vulkan controls remain live-test pending.')
