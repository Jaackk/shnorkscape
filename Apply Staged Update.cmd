...
set "expected=BC3F2B3D5A5B739B85101069646C0C4AF233200488AE9C303860EBD3157FB208"
...
if /i "%~1"=="--check-only" (
 echo Combat, Necromancy book, cooldowns, gear kits, saved locations and bar-copy candidate hash verified. Nothing installed or restarted.
 popd
 exit /b 0
)
...
echo Combat, Necromancy book, cooldowns, gear kits, saved locations and bar-copy update installed. Backup: %backup%
