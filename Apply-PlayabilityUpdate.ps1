...
$libraryUpdate=$manifest.candidate -in @('library-followup-20260923','p0-bank-focus-20260923','bank-sort-20260923','combat-completion-20260923','combat-live-successor-20260923','combat-live-successor-refinement-20260923','combat-live-successor-polish-20260924','combat-live-successor-polish2-20260924','combat-live-successor-qol-20260924')
...
if ($manifest.candidate -in @('bank-sort-20260923','combat-completion-20260923','combat-live-successor-20260923','combat-live-successor-refinement-20260923','combat-live-successor-polish-20260924','combat-live-successor-polish2-20260924','combat-live-successor-qol-20260924')) { $expectedTargets += 'cache/12/13830.dat' }
if ($manifest.candidate -in @('combat-live-successor-polish2-20260924','combat-live-successor-qol-20260924')) { $expectedTargets += @('cache/18/236.dat','cache/18/243.dat','cache/19/239.dat','cache/255/18.dat','cache/255/19.dat') }
if ($manifest.candidate -notin @('playability-20260923','library-followup-20260923','p0-bank-focus-20260923','bank-sort-20260923','combat-completion-20260923','combat-live-successor-20260923','combat-live-successor-refinement-20260923','combat-live-successor-polish-20260924','combat-live-successor-polish2-20260924','combat-live-successor-qol-20260924') -or $manifest.files.Count -ne $expectedTargets.Count) { throw 'Unexpected update manifest.' }
$planned = @()
