...
$libraryUpdate=$manifest.candidate -in @('library-followup-20260923','p0-bank-focus-20260923','bank-sort-20260923','combat-completion-20260923','combat-live-successor-20260923','combat-live-successor-refinement-20260923')
...
if ($manifest.candidate -in @('bank-sort-20260923','combat-completion-20260923','combat-live-successor-20260923','combat-live-successor-refinement-20260923')) { $expectedTargets += 'cache/12/13830.dat' }
if ($manifest.candidate -notin @('playability-20260923','library-followup-20260923','p0-bank-focus-20260923','bank-sort-20260923','combat-completion-20260923','combat-live-successor-20260923','combat-live-successor-refinement-20260923') -or $manifest.files.Count -ne $expectedTargets.Count) { throw 'Unexpected update manifest.' }
$planned = @()
