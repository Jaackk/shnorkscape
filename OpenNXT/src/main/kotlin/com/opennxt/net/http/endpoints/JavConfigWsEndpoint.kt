...
object JavConfigWsEndpoint {
    ...
    internal fun loadBaseConfig(
        ...
        if (offline) return loadBundledConfig(type, "patched")
        loadLiveConfig(type, useLiveCache, liveConfigUrlOverride ?: LIVE_JAV_CONFIG_URL, offline)?.let { return it }
    ...
    internal fun prepareConfig(
        ...
        val (config, loadedSource) = when {
            ...
            else -> loadBaseConfig(type, baseConfigSource, effectiveLiveCache, liveConfigUrlOverride, offline)
        }
